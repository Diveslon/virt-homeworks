...
Выберем неизменяеую инфраструктуру,чтобы избежать дрейфа конфигураций
Будет ли центральный сервер для управления инфраструктурой?
Чтобы избежать дополнительных затрат следует выбрать структуру без выделенного сервера
Будут ли агенты на серверах?
Чтобы опять таки избежать дополнительных затрат выберем конфигурацию без агентов на серверах
